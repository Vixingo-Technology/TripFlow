    ...
    <Box p={4} sx={{minHeight:"100%"}}>
      <Grid container spacing={4}>
        ...
        <Grid size={{ xs: 12, md: 6 }} >
          <Typography color="text.primary" variant="h4" fontWeight="bold">Fire Insurance</Typography>
          ...
          <Typography color="text.primary" variant="body2" sx={{ mt: 3 }}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Typography color="text.primary" variant="h5" fontWeight="bold" gutterBottom>Fire Insurance</Typography>
          <Typography color="text.primary" variant="body2">Protect your house with Trip Insurance</Typography>

          {/* Construction Class */}
          <Typography color="text.primary" mt={4} fontWeight="bold">Construction Class</Typography>
            ...
            { label: 'Half Brick', value: 'half-brick', img: halfBrick }].map(({ label, value, img }) => (
              <Grid size={{ xs: 12, md: 4 }} key={value}>
                ...
                >
                  ...
                  <Typography color="text.primary" fontWeight="medium">{label}</Typography>
                  {construction === value && (
                    <Box
                      sx={{
                        position: 'absolute',
          ...
          {/* Protection Type */}
          <Typography color="text.primary" mt={4} fontWeight="bold">I would like to protect my</Typography>
          <Grid container spacing={2} mt={1}>
            {[{
              ...
              <Grid size={{ xs: 12, md: 4 }} key={value}>
                ...
                >
                  ...
                  <Typography color="text.primary" fontWeight="medium" fontSize={14}>{label}</Typography>
          ...
          <Paper sx={{ mt: 4, p: 3, bgcolor: 'yellow.50' }} elevation={0}>
            <Typography color="text.primary" fontWeight="bold">Coverage Amount</Typography>
            <Typography color="text.primary" variant="caption">Note: Figure will be rounded based on the last 3 digits</Typography>
            <TextField
              fullWidth
              type="number"
            ...
            <Box
              ...
              borderRadius={1}
            >
              <Typography color="text.primary" fontWeight="bold">Total sum covered amount</Typography>
              <Typography color="text.primary" fontWeight="bold">${total.toFixed(2)}</Typography>
            </Box>
          </Paper>

          {/* Extras */}
          <Box mt={4}>
            <Typography color="text.primary" fontWeight="bold">Extras (%)</Typography>
            ...
            <Collapse in={extrasOpen} collapsedSize={0} unmountOnExit>
  <Paper variant="outlined" sx={{ mt: 2, p: 3 }}>
    <Typography color="text.primary" fontWeight="bold" mb={2}>
    ...
    >
      ...
      <Typography color="text.primary">
        Drag and drop an image here or click, max 5 images allowed.
      </Typography>
      {files.length > 0 && (
        <Typography color="text.primary" mt={1}>
          ...
          {pay ?
            <>
              <Typography color="text.primary" variant='h4' mt={2} textAlign='center'>
                Total Payable: ${total}
              </Typography>
              <Button onClick={() => { navigate('/customerDetailsForm')}} variant='contained' fullWidth
              sx={{ mt: 4, fontWeight: 'bold' }}>Pay Now</Button>
            </>
            : <Button
              fullWidth
              variant="contained"
          ...
          <Typography color="text.primary" variant="caption" textAlign="center" display="block" mt={4}>
